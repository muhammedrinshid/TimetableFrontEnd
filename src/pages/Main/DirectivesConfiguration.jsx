...
const DirectivesConfiguration = () => {
  ...
  const directiveDescriptions = {
    elective_group_timeslot: "Ensures that elective subjects are scheduled at the same time for all groups.",
    ensure_teacher_assigned: "Guarantees that every lesson has an assigned teacher.",
    ensure_timeslot_assigned: "Ensures all lessons are allocated a time slot.",
    tutor_lesson_load: "Ensures tutors have a balanced workload, with assigned lessons falling within the specified minimum and maximum limits per week.",
    daily_lesson_limit: "Prevents exceeding the maximum number of lessons per day, calculated as the maximum lessons per week divided by the number of working days.",
    prefer_consistent_teacher_for_subject: "Aims to assign the same teacher for a subject throughout the term.",
    prefer_subject_once_per_day: "Tries to schedule a subject only once per day.",
    avoid_teacher_consecutive_periods_overlapping_class: "Prevents back-to-back lessons for teachers.",
    avoid_continuous_subjects: "Prevents the same subject from being taught in consecutive periods.",
    avoid_continuous_teaching: "Ensures breaks between teaching periods for teachers.",
    avoid_consecutive_elective_lessons: "Prevents elective subjects from being scheduled back-to-back."
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 dark:bg-dark-background text-dark-primary dark:text-light-primary overflow-y-scroll">
      <h1 className="text-3xl font-bold mb-6 text-center text-dark-primary dark:text-light-primary">Directives Configuration</h1>
      
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-dark-accent dark:text-light-accent">Mandatory Directives</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <DirectiveItem
            ...
            onChange={() => updateDirective('elective_group_timeslot', !directives.elective_group_timeslot)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('ensure_teacher_assigned', !directives.ensure_teacher_assigned)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('ensure_timeslot_assigned', !directives.ensure_timeslot_assigned)}
            disabled={false}
          />
        </div>
      </div>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-dark-accent dark:text-light-accent">Optional Directives</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <DirectiveItem
            name="tutor_lesson_load"
            description={directiveDescriptions.tutor_lesson_load}
            value={directives.tutor_lesson_load}
            onChange={() => updateDirective('tutor_lesson_load', !directives.tutor_lesson_load)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('daily_lesson_limit', !directives.daily_lesson_limit)}
            disabled={false}
          />
          <DirectiveItem
            name="prefer_consistent_teacher_for_subject"
            description={directiveDescriptions.prefer_consistent_teacher_for_subject}
            value={directives.prefer_consistent_teacher_for_subject}
            onChange={() => updateDirective('prefer_consistent_teacher_for_subject', !directives.prefer_consistent_teacher_for_subject)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('prefer_subject_once_per_day', !directives.prefer_subject_once_per_day)}
            disabled={false}
          />
          <DirectiveItem
            name="avoid_teacher_consecutive_periods_overlapping_class"
            description={directiveDescriptions.avoid_teacher_consecutive_periods_overlapping_class}
            value={directives.avoid_teacher_consecutive_periods_overlapping_class}
            onChange={() => updateDirective('avoid_teacher_consecutive_periods_overlapping_class', !directives.avoid_teacher_consecutive_periods_overlapping_class)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('avoid_continuous_subjects', !directives.avoid_continuous_subjects)}
            disabled={false}
          />
          <DirectiveItem
            ...
            onChange={() => updateDirective('avoid_continuous_teaching', !directives.avoid_continuous_teaching)}
            disabled={false}
          />
          <DirectiveItem
            name="avoid_consecutive_elective_lessons"
            description={directiveDescriptions.avoid_consecutive_elective_lessons}
            value={directives.avoid_consecutive_elective_lessons}
            onChange={() => updateDirective('avoid_consecutive_elective_lessons', !directives.avoid_consecutive_elective_lessons)}
            disabled={false}
          />
        </div>
      </div>
