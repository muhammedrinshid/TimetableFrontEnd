...
const TeachersList = ({
  ...
  const handleSelectedTeacher = (teacher_id) => {
    ...
    setISelectedTeacher((prev) => ({ ...teacher, isopen: true }));
  };


  const filteredTeachers = teachers
    ?.filter(teacher =>
      gradeType === "" || teacher.grades_display.some(grade => grade.id === gradeType)
    )
    .filter(teacher =>
                ...
                <div className="flex flex-row mt-8 justify-between gap-5">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <IconButton
                      ...
                      size="small"
                      style={iconStyle}
                      onClick={() => handleSelectedTeacher(teacher.teacher_id)}
                    >
