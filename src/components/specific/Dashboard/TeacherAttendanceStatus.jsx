...
const TeacherAttendanceStatus = ({
  ...
  return (
    <div className="overflow-y-auto relative bg-white dark:bg-dark-background text-slate-700 dark:text-dark-text h-full">
                  ...
                  <div className="border-x border-slate-200 dark:border-dark-border flex-1 py-1 px-3 flex flex-col justify-center font-Inter">
                    ...
                    <div className="flex flex-wrap flex-row gap-2 items-end">
                      {teacher.instructor.qualified_subjects.map((sub) => (
                        <p
                          className="text-[10px] p-[2px] w-fit px-2 text-nowrap font-semibold font-sans rounded-lg bg-pale_orange bg-opacity-60 text-white dark:bg-dark-secondary dark:text-dark-highlight"
                          key={sub.id}
                        >
                          {sub.name}
                        </p>
