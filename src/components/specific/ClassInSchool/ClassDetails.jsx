    ...
    <div className="w-full h-full   rounded-2xl px-6 py-5">
      <div className="flex flex-row justify-between border-b pb-4">
        <div className="flex flex-row items-center gap-4">
          ...
          <Avatar
            ...
            src={SelectedClassforView?.image}
          >
            {SelectedClassforView?.name}
          </Avatar>
          <h1 className="text-xl font-semibold ">
      ...
      <div className="flex flex-row pt-6 pl-1 border-b pb-5">
        <div className="basis-1/3 flex flex-col px-3">
          ...
          <LabelDisplayer data={SelectedClassforView?.name} label={"Name"} />
          <LabelDisplayer
            data={SelectedClassforView?.surname}
            label={"Surname"}
          />
        </div>
        <div className="basis-1/3 px-3">
          ...
          <LabelDispalyerWithIcon
            data={SelectedClassforView?.email}
            label={"Mail id"}
          />
          <LabelDispalyerWithIcon
            data={SelectedClassforView?.phone}
            label={"Phone"}
          />
          ...
          <div className="flex gap-2 flex-wrap">
            {SelectedClassforView?.qualified_subjects?.map((subject) => (
          ...
          <LabelDisplayer
            data={SelectedClassforView?.teacher_id}
            label={"Teacher Id"}
          />
        </div>
        <div className="basis-1/3 px-3 ">
          ...
          />
          <LabelDisplayer
            data={SelectedClassforView?.minimum_number_periods_per_week}
            label={"Min number of period"}
          />
          <LabelDisplayer
            data={SelectedClassforView?.maximum_number_periods_per_week}
      ...
      <div className=" overflow-auto py-6">
        ...
        <div className={`grid ${gridClassName} `}>
          ...
          {SelectedClassforView?.time_table?.map((obj) => (
            <React.Fragment>
              <div className="sticky left-0  bg-white  z-10  border border-gray-300 border-opacity-15  bg-opacity-70 backdrop-blur-sm flex justify-center p-2 items-center">
                <div className="w-full h-full flex flex-col justify-center items-center gap-2 bg-light-secondary bg-opacity-20 rounded-lg p-2 shadow-custom-10 ">
                  {" "}
