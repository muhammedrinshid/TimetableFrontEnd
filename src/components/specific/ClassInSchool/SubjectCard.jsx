      ...
      <div className="flex">
        ...
        <div className="flex-grow p-4">
          <div className="flex justify-between items-start mb-3">
            ...
            <div className="flex">
              <IconButton size="small" onClick={() => onEdit(subject)} className="mr-1">
                <EditIcon fontSize="small" />
              </IconButton>
              <IconButton size="small" onClick={() => setIsDeleteClassSubjectForm(subject?.id)}>
              ...
              <div className="flex justify-between items-center mb-3">
                {subject.elective_group ? (
                  <div className="flex items-center">
                    <GroupIcon fontSize="small" className="mr-2 text-purple-500" />
                    <span className="text-sm font-medium text-purple-600">{subject.elective_group.name}</span>
                ...
                {subject?.options?.map((option, optionIndex) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-semibold text-gray-700">{option.subject.name}</span>
                      <Chip 
                    ...
                    {option.preferred_rooms && option.preferred_rooms.length > 0 && (
                      <div className="mt-2">
                        <span className="text-xs font-medium text-gray-600">Preferred Rooms:</span>
                        <div className="flex flex-wrap">
